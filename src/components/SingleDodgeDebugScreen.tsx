  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-slate-950 text-white">
      ...
      <div className="mx-auto flex w-full max-w-5xl min-h-0 flex-1 flex-col gap-3 p-3 sm:gap-4 sm:p-4">
        <div className="h-[46vh] min-h-[300px] max-h-[62vh] w-full flex-none overflow-hidden rounded-2xl sm:h-[52vh] sm:min-h-[360px] lg:h-auto lg:max-h-none lg:min-h-[460px] lg:flex-[1.25]">
          <DodgeGame
            me={me}
            players={playerMap}
